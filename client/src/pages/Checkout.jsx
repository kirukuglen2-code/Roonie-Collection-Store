...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect to success page (you'll need to create this)
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                {/* Contact Information */}
                <div className="bg-white rounded-2xl shadow-soft p-6 border border-neutral-200 animate-fade-in-up">
                ...
                {/* Shipping Address */}
                <div className="bg-white rounded-2xl shadow-soft p-6 border border-neutral-200 animate-fade-in-up animation-delay-100">
                ...
                {/* Payment Method */}
                <div className="bg-white rounded-2xl shadow-soft p-6 border border-neutral-200 animate-fade-in-up animation-delay-200">
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-2xl shadow-soft p-6 border border-neutral-200 sticky top-8 animate-fade-in-up animation-delay-300">
                ...
                {/* Trust Indicators */}
                <div className="bg-white rounded-2xl shadow-soft p-6 border border-neutral-200 animate-fade-in-up animation-delay-400">
